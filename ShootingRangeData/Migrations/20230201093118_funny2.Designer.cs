...
namespace ShootingRangeData.Migrations
{
    ...
    [Migration("20230201093118_funny2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShootingRangeData.ShootingRangeDB.Gun", b =>
                {
                    ...
                    b.Property<Guid?>("GunCategoryID")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("GunLaneTypeID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShootingRangeData.ShootingRangeDB.Gun", b =>
                {
                    b.HasOne("ShootingRangeData.ShootingRangeDB.GunCategory", null)
                        .WithMany("Guns")
                        .HasForeignKey("GunCategoryID");

                    b.HasOne("ShootingRangeData.ShootingRangeDB.GunLaneType", null)
                        .WithMany("Guns")
                        .HasForeignKey("GunLaneTypeID");
                });
