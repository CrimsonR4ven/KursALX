...
namespace ShootingRangeForms.PresentBoxes
{
	public class LaneChoicePresentBox : IPresentBox
	{
		...
		public LaneChoicePresentBox(LaneHolder laneUsedOne, LaneHolder laneUsedTwo, Cart myCart, Form1 form)
		{
			...
			PictureOne.BackColor = Color.Transparent;
			PictureOne.SizeMode = PictureBoxSizeMode.Zoom;
			...
			PictureTwo.BackColor = Color.Transparent;
			...
			BuyButtonTwo.Click += new EventHandler(AddToCart);
